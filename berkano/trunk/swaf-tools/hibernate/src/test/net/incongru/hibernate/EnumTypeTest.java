...
import net.incongru.hibernate.stuff.BasicVegetable;
import net.incongru.hibernate.stuff.Sandwich;
import net.incongru.hibernate.stuff.Sauce;
...
public class EnumTypeTest extends HibernateTestCase {
    protected void exportSchema() throws HibernateException {
        exportSchema(new String[]{"net/incongru/hibernate/dummy-enum.hbm.xml"});
    }
