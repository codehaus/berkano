...
<@ww.textfield label="getText('useredit.username')" name="'userName'" id="userName" value="userName" /><br />
<@ww.textfield label="getText('useredit.fullname')" name="'fullName'" id="fullName" value="fullName" /><br />
<@ww.textfield label="getText('useredit.email')" name="'email'" id="email" value="email" /><br />
