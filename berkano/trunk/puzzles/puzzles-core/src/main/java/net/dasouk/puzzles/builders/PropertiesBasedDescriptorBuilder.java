 ...
 * possible fields:
 * <ul>
 * <li>name</li>         (<strong>REQUIRED</strong>)
 * <li>family</li>       (<strong>REQUIRED</strong>)
 * <li>author</li>
 * <li>url</li>
...
public class PropertiesBasedDescriptorBuilder implements PluginDescriptorBuilder {
    public PluginDescriptor buildDescriptor(URL descriptorUrl) throws PluginDescriptorException {
        ...
        try {
            ...
            throw new PluginDescriptorException(e.getMessage(), e, descriptorUrl);
        } catch (IllegalArgumentException e) {
            throw new PluginDescriptorException(e.getMessage(), e, descriptorUrl);
        }
    }

    protected Collection<String> explode(String concatenatedString, String separators) {
